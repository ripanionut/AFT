const Toast = ({ msg, handleShow, bgColor }) => {
  return (
    <div id="toast-warning" class=" mt-3 absolute bot-10 right-5 flex items-center w-full max-w-xs p-4 text-dark-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-orange-500 bg-orange-100 rounded-lg dark:bg-orange-700 dark:text-orange-200">
      ...
      <div class="ml-3 text-sm  font-normal">{msg.msg}</div>
      <button
        onClick={handleShow}
        type="button"
